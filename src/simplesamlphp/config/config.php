...
$config = array(
     ...
     */
    'secretsalt' => '11le0rmndwwt19jc7fc8foxa70ekh8aj',
    ...
    'technicalcontact_email' => 'support@donnu.edu.ua',
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'mysql:host=localhost;dbname=wifiportal',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => 'wifiportal',
    'store.sql.password' => 'qwe123qwe!@',

    /*
     * The prefix we should use on our tables.
     */
    'store.sql.prefix' => 'wifiPortal',
