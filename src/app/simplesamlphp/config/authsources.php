...
$config = array(
    ...
    'adfs-sp' => array(
        ...
        'entityID' => NULL,
        'idp' => 'http://fs.donnu.edu.ua/adfs/services/trust',
        'discoURL' => NULL,
    ...
    'default-sp' => array(
        ...
        'entityID' => 'https://exportalunifi.azurewebsites.net',

        // The entity ID of the IdP this should SP should contact.
        // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
       'idp' => 'https://sts.windows.net/390c7c61-4a5e-479e-a8b5-a05b21d22d78/',
